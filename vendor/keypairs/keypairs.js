import { __module as keypairs } from './_virtual/keypairs.js';
import require$$0 from 'eckles';
import require$$1 from 'rasha';
import require$$2 from 'crypto';

(function (module) {

	function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
	var Eckles = require$$0;
	var Rasha = require$$1;
	var Enc = {};
	  ...
	  if (!opts.key || !opts.key.kty) {
	    try {
	      ...
	      p = Keypairs["import"]({
	        ...
	        err = new Error("Could not parse key (type " + _typeof(opts.key) + ") '" + opts.key + "': " + e.message);
	        err.code = "EPARSE";
	        return Promise.reject(err);
	      });
	    }
	...
	Keypairs.publish = function (opts) {
	  if ('object' !== _typeof(opts.jwk) || !opts.jwk.kty) {
	...
	Keypairs.signJws = function (opts) {
	  return Keypairs.thumbprint(opts).then(function (thumb) {
	    ...
	    function sign(pem) {
	      ...
	      var binsig = require$$2.createSign(nodeAlg).update(protect ? protected64 + "." + payload64 : payload64).sign(pem);
	      if ('EC' === opts.jwk.kty) {
